...
public class Bank {
	...
	public void openAccount(String accountid) throws AccountExistsException {
		if (accountlist.containsKey(accountid)) {
			...
			//metoda openAccount nie rzucała wyjątku 'AccountExistsException', kiedy próbowałem otworzyć 2 konta o tym samym id
...
//		 metoda deposit rzucała wyjątek 'AccountDoesNotExistException', kiedy została wywołana z id istniejącego konta
		//if (accountlist.containsKey(accountid)) {
		if (!accountlist.containsKey(accountid)) {
			...
			//zamiast zmniejszyć ilość pieniędzy, metoda withdraw dodała je do konta
	...
	public void transfer(String fromaccount, String toaccount, Money amount) throws AccountDoesNotExistException {
		 //ilość pieniędzy nadawcy nie zmieniła się
